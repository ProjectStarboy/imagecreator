...
import { AppService, eVehicleModType, } from '@core-shared/interfaces';
...
let ScreenshotService = class ScreenshotService extends AppService {
    ...
    async prepareGreenscreen() {
        ...
        this.greenscreenEntity = CreateObject(modelHash, ScreenCoords[0], ScreenCoords[1], ScreenCoords[2], false, false, false);
        SetEntityHeading(this.greenscreenEntity, 0.0);
        FreezeEntityPosition(this.greenscreenEntity, true);
        FreezeEntityPosition(playerPed, true);
        this.camera = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', ScreenCoords[0], ScreenCoords[1], ScreenCoords[2] + 10.0, 0, 0, 0, 60, true, 2);
    ...
    setVehicleProperties(vehicle, props) {
        ...
        if (props.customColorPrimary) {
            SetVehicleCustomPrimaryColour(vehicle, props.customColorPrimary.r, props.customColorPrimary.g, props.customColorPrimary.b);
        }
        if (props.customColorSecondary) {
            SetVehicleCustomPrimaryColour(vehicle, props.customColorSecondary.r, props.customColorSecondary.g, props.customColorSecondary.b);
        }
        if (props.extras) {
        ...
        if (props.mods) {
            if (props.mods.VMT_ARMOUR)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ARMOUR, props.mods.VMT_ARMOUR, false);
            if (props.mods.VMT_BONNET)
                SetVehicleMod(vehicle, eVehicleModType.VMT_BONNET, props.mods.VMT_BONNET, false);
            if (props.mods.VMT_BRAKES)
                SetVehicleMod(vehicle, eVehicleModType.VMT_BRAKES, props.mods.VMT_BRAKES, false);
            if (props.mods.VMT_BUMPER_F)
                SetVehicleMod(vehicle, eVehicleModType.VMT_BUMPER_F, props.mods.VMT_BUMPER_F, false);
            if (props.mods.VMT_BUMPER_R)
                SetVehicleMod(vehicle, eVehicleModType.VMT_BUMPER_R, props.mods.VMT_BUMPER_R, false);
            if (props.mods.VMT_CHASSIS2)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS2, props.mods.VMT_CHASSIS2, false);
            if (props.mods.VMT_CHASSIS3)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS3, props.mods.VMT_CHASSIS3, false);
            if (props.mods.VMT_CHASSIS4)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS4, props.mods.VMT_CHASSIS4, false);
            if (props.mods.VMT_CHASSIS5)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS5, props.mods.VMT_CHASSIS5, false);
            if (props.mods.VMT_CHASSIS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS, props.mods.VMT_CHASSIS, false);
            if (props.mods.VMT_DOOR_L)
                SetVehicleMod(vehicle, eVehicleModType.VMT_DOOR_L, props.mods.VMT_DOOR_L, false);
            if (props.mods.VMT_DOOR_R)
                SetVehicleMod(vehicle, eVehicleModType.VMT_DOOR_R, props.mods.VMT_DOOR_R, false);
            if (props.mods.VMT_ENGINE)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ENGINE, props.mods.VMT_ENGINE, false);
            if (props.mods.VMT_ENGINEBAY1)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ENGINEBAY1, props.mods.VMT_ENGINEBAY1, false);
            if (props.mods.VMT_ENGINEBAY2)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ENGINEBAY2, props.mods.VMT_ENGINEBAY2, false);
            if (props.mods.VMT_ENGINEBAY3)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ENGINEBAY3, props.mods.VMT_ENGINEBAY3, false);
            if (props.mods.VMT_EXHAUST)
                SetVehicleMod(vehicle, eVehicleModType.VMT_EXHAUST, props.mods.VMT_EXHAUST, false);
            if (props.mods.VMT_GEARBOX)
                SetVehicleMod(vehicle, eVehicleModType.VMT_GEARBOX, props.mods.VMT_GEARBOX, false);
            if (props.mods.VMT_GRILL)
                SetVehicleMod(vehicle, eVehicleModType.VMT_GRILL, props.mods.VMT_GRILL, false);
            if (props.mods.VMT_HORN)
                SetVehicleMod(vehicle, eVehicleModType.VMT_HORN, props.mods.VMT_HORN, false);
            if (props.mods.VMT_HYDRAULICS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_HYDRAULICS, props.mods.VMT_HYDRAULICS, false);
            if (props.mods.VMT_HYDRO)
                SetVehicleMod(vehicle, eVehicleModType.VMT_HYDRO, props.mods.VMT_HYDRO, false);
            if (props.mods.VMT_ICE)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ICE, props.mods.VMT_ICE, false);
            if (props.mods.VMT_INTERIOR1)
                SetVehicleMod(vehicle, eVehicleModType.VMT_INTERIOR1, props.mods.VMT_INTERIOR1, false);
            if (props.mods.VMT_INTERIOR2)
                SetVehicleMod(vehicle, eVehicleModType.VMT_INTERIOR2, props.mods.VMT_INTERIOR2, false);
            if (props.mods.VMT_INTERIOR3)
                SetVehicleMod(vehicle, eVehicleModType.VMT_INTERIOR3, props.mods.VMT_INTERIOR3, false);
            if (props.mods.VMT_INTERIOR4)
                SetVehicleMod(vehicle, eVehicleModType.VMT_INTERIOR4, props.mods.VMT_INTERIOR4, false);
            if (props.mods.VMT_CHASSIS5)
                SetVehicleMod(vehicle, eVehicleModType.VMT_CHASSIS5, props.mods.VMT_CHASSIS5, false);
            if (props.mods.VMT_KNOB)
                SetVehicleMod(vehicle, eVehicleModType.VMT_KNOB, props.mods.VMT_KNOB, false);
            if (props.mods.VMT_LIGHTBAR)
                SetVehicleMod(vehicle, eVehicleModType.VMT_LIGHTBAR, props.mods.VMT_LIGHTBAR, false);
            if (props.mods.VMT_LIVERY_MOD)
                SetVehicleMod(vehicle, eVehicleModType.VMT_LIVERY_MOD, props.mods.VMT_LIVERY_MOD, false);
            if (props.mods.VMT_NITROUS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_NITROUS, props.mods.VMT_NITROUS, false);
            if (props.mods.VMT_PLAQUE)
                SetVehicleMod(vehicle, eVehicleModType.VMT_PLAQUE, props.mods.VMT_PLAQUE, false);
            if (props.mods.VMT_PLTHOLDER)
                SetVehicleMod(vehicle, eVehicleModType.VMT_PLTHOLDER, props.mods.VMT_PLTHOLDER, false);
            if (props.mods.VMT_PLTVANITY)
                SetVehicleMod(vehicle, eVehicleModType.VMT_PLTVANITY, props.mods.VMT_PLTVANITY, false);
            if (props.mods.VMT_ROOF)
                SetVehicleMod(vehicle, eVehicleModType.VMT_ROOF, props.mods.VMT_ROOF, false);
            if (props.mods.VMT_SEATS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_SEATS, props.mods.VMT_SEATS, false);
            if (props.mods.VMT_SKIRT)
                SetVehicleMod(vehicle, eVehicleModType.VMT_SKIRT, props.mods.VMT_SKIRT, false);
            if (props.mods.VMT_SPOILER)
                SetVehicleMod(vehicle, eVehicleModType.VMT_SPOILER, props.mods.VMT_SPOILER, false);
            if (props.mods.VMT_STEERING)
                SetVehicleMod(vehicle, eVehicleModType.VMT_STEERING, props.mods.VMT_STEERING, false);
            if (props.mods.VMT_SUBWOOFER)
                SetVehicleMod(vehicle, eVehicleModType.VMT_SUBWOOFER, props.mods.VMT_SUBWOOFER, false);
            if (props.mods.VMT_SUSPENSION)
                SetVehicleMod(vehicle, eVehicleModType.VMT_SUSPENSION, props.mods.VMT_SUSPENSION, false);
            if (props.mods.VMT_TRUNK)
                SetVehicleMod(vehicle, eVehicleModType.VMT_TRUNK, props.mods.VMT_TRUNK, false);
            if (props.mods.VMT_TURBO)
                ToggleVehicleMod(vehicle, eVehicleModType.VMT_TURBO, props.mods.VMT_TURBO);
            if (props.mods.VMT_TYRE_SMOKE)
                ToggleVehicleMod(vehicle, eVehicleModType.VMT_TYRE_SMOKE, props.mods.VMT_TYRE_SMOKE);
            if (props.mods.VMT_WHEELS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_WHEELS, props.mods.VMT_WHEELS, false);
            if (props.mods.VMT_WHEELS_REAR_OR_HYDRAULICS)
                SetVehicleMod(vehicle, eVehicleModType.VMT_WHEELS_REAR_OR_HYDRAULICS, props.mods.VMT_WHEELS_REAR_OR_HYDRAULICS, false);
            if (props.mods.VMT_WING_L)
                SetVehicleMod(vehicle, eVehicleModType.VMT_WING_L, props.mods.VMT_WING_L, false);
            if (props.mods.VMT_WING_R)
                SetVehicleMod(vehicle, eVehicleModType.VMT_WING_R, props.mods.VMT_WING_R, false);
            if (props.mods.VMT_XENON_LIGHTS)
                ToggleVehicleMod(vehicle, eVehicleModType.VMT_XENON_LIGHTS, props.mods.VMT_XENON_LIGHTS);
    ...
    async spawnVehicle(name, props) {
        ...
        const frontGreenscreen = GetOffsetFromEntityInWorldCoords(this.greenscreenEntity, 0.0, -5.0, 0.0);
        this.spawnedVehicle = CreateVehicle(vehicleHash, frontGreenscreen[0], frontGreenscreen[1], frontGreenscreen[2], 0, false, false);
        ...
        const camOffsetFromGreenScreen = GetOffsetFromEntityInWorldCoords(this.greenscreenEntity, 0.0, -12.5, 1.5);
        SetCamCoord(this.camera, camOffsetFromGreenScreen[0], camOffsetFromGreenScreen[1], camOffsetFromGreenScreen[2]);
    ...
    async createClotheAsset(name) {
        ...
        TaskPlayAnim(PlayerPedId(), 'mp_sleep', 'bind_pose_180', 999.0, 999.0, -1, 1, 1, true, true, true);
        await Sleep(100);
        ...
        switch (Number(componentId)) {
            case 0: {
                ...
                this.camera = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', headCam.camPos[0], headCam.camPos[1], headCam.camPos[2], headCam.camRot[0], headCam.camRot[1], headCam.camRot[2], headCam.camFov, true, 2);
                SetCamActive(this.camera, true);
                RenderScriptCams(true, false, 0, true, false);
                const bonePosition = GetPedBoneCoords(PlayerPedId(), Bones.SKEL_Head, 0.0, 0.0, 0.0);
                PointCamAtCoord(this.camera, bonePosition[0], bonePosition[1], bonePosition[2]);
                break;
            }
            case 1: {
                /* this.camera = World.createCamera(
            ...
            case 3: {
                ...
                this.camera = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', bodyCam.camPos[0], bodyCam.camPos[1], bodyCam.camPos[2], bodyCam.camRot[0], bodyCam.camRot[1], bodyCam.camRot[2], bodyCam.camFov, true, 2);
                SetCamActive(this.camera, true);
                RenderScriptCams(true, false, 0, true, false);
                const bonePosition = GetPedBoneCoords(PlayerPedId(), Bones.SKEL_Spine3, 0.0, 0.0, 0.0);
                PointCamAtCoord(this.camera, bonePosition[0], bonePosition[1], bonePosition[2]);
                break;
            }
            case 4: {
                ...
                this.camera = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', legCam.camPos[0], legCam.camPos[1], legCam.camPos[2], legCam.camRot[0], legCam.camRot[1], legCam.camRot[2], legCam.camFov, true, 2);
                SetCamActive(this.camera, true);
                RenderScriptCams(true, false, 0, true, false);
                const bonePosition = GetPedBoneCoords(PlayerPedId(), Bones.SKEL_Spine3, 0.0, 0.0, 0.0);
                PointCamAtCoord(this.camera, bonePosition[0], bonePosition[1], bonePosition[2]);
            ...
            case 6: {
                ...
                this.camera = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', shoeCam.camPos[0], shoeCam.camPos[1], shoeCam.camPos[2], shoeCam.camRot[0], shoeCam.camRot[1], shoeCam.camRot[2], shoeCam.camFov, true, 2);
                SetCamActive(this.camera, true);
                RenderScriptCams(true, false, 0, true, false);
                const bonePosition = GetPedBoneCoords(PlayerPedId(), Bones.SKEL_R_Foot, 0.0, 0.0, 0.0);
                PointCamAtCoord(this.camera, bonePosition[0], bonePosition[1], bonePosition[2]);
                break;
            }
            case 7: {
        ...
        if (!this.camera)
            return;
        if (IsPedComponentVariationValid(PlayerPedId(), Number(componentId), Number(drawableId), Number(textureId))) {
            SetPedPreloadVariationData(PlayerPedId(), Number(componentId), Number(drawableId), Number(textureId));
            const curTime = GetGameTimer();
            while (!HasPedPreloadVariationDataFinished(PlayerPedId()) &&
                GetGameTimer() - curTime < 5000) {
                await Sleep(100);
            }
            if (HasPedPreloadVariationDataFinished(PlayerPedId())) {
                SetPedComponentVariation(PlayerPedId(), Number(componentId), Number(drawableId), Number(textureId), 0);
                await Sleep(100);
                /* await emitCallback(
